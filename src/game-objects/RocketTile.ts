    ...
    public destroyRocket(): void {
        ...
        if (this.direction === 'HORIZONTAL') {
            ...
            for (let offset = 1; offset < CONST.gridWidth; offset++) {
                this.addDestroyTweens(gameScene, this.secondTweens, centerRow, centerCol + offset, destroy)
                this.addDestroyTweens(gameScene, this.firstTweens, centerRow, centerCol - offset, destroy)
            }
            ...
            for (let offset = 1; offset < CONST.gridHeight; offset++) {
                this.addDestroyTweens(gameScene, this.secondTweens, centerRow + offset, centerCol, destroy)
                this.addDestroyTweens(gameScene, this.firstTweens, centerRow - offset, centerCol, destroy)
            }
        }
